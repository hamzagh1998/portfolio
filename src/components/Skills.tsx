...
const skillCategories = [
  {
    title: 'Front-End',
    skills: ['React.js', 'Next.js', 'Vue.js', 'TypeScript', 'Tailwind CSS', 'Zustand']
  },
  {
    title: 'Back-End & AI',
    skills: ['Node.js', 'Bun', 'Python (FastAPI)', 'PostgreSQL', 'MongoDB', 'OpenAI API']
  },
  {
    title: 'DevOps & Tools',
    skills: ['Docker', 'CI/CD', 'Git', 'Linux', 'Cloudflare']
  }
];
